      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", flex: 1, width: "100%" }}>
            <TextField label="Nome" style={{ flex: 1 }} onChange={(e) => setName(e.target.value)} />
          </div>
          <div style={{ display: "flex", flex: 1, width: "100%" }}>
            <TextField label="Descrição" style={{ flex: 1 }} onChange={(e) => setDescription(e.target.value)} />
          </div>
          ...
          <div style={{ display: "flex", flex: 1, width: "100%", marginTop: 32 }}>
            <FormControl component="fieldset" style={{}}>
              <FormLabel component="legend">Cobrança</FormLabel>
